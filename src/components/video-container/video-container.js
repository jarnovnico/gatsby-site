...
import $ from 'jquery'
import fallbackImg from '../../assets/images/error-img.png'
...
// export default class VideoContainerMain extends React.Component {
//   render() {
//     return(
...
const VideoContainer = ({ siteTitle }) => (
  <div className="video-container">
